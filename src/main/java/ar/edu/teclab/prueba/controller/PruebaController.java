...
public class PruebaController {
	...
	@GetMapping(value = "/comments", produces = MediaType.APPLICATION_JSON_VALUE) //comentarios del ticket
	public ResponseEntity<String> getComments(@RequestParam(value ="ticket",defaultValue="9") int id) {		
		try {			
			Ticket tkt = new Ticket();
			tkt.setId(id);			
			return new ResponseEntity<String>(tkt.getComments(), HttpStatus.OK);			
		}catch (Exception e){
			LOG.error("Error", e);
		}
		return null;
